Grupo 1: 
Fábio, Augusto, Vinicius, Wesley Rieta   - MÓDULO 03: Consulta a agenda de tarefas

Grupo 2: 
Alexia, Luís, Lafayette    - MÓDULO 01: Administração de usuários e perfis

Grupo 3: 
Lucas, Wesley Koepp, Bernardo, Pedro Henrique – MÓDULO 02: Agendamento de tarefas

Objetivo: Produzir o back end do sistema de Agendamento de Gestão de tarefas. 
...
TestesUnitários – Camada de Teste. 
